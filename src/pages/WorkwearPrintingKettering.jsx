...
export default function WorkwearPrintingKettering() {
  useEffect(() => {
    document.title =
      "Workwear Printing Kettering | Custom Printed Workwear | Kett Press Co";

    const meta = document.createElement("meta");
    meta.name = "description";
    meta.content =
      "Professional Workwear printing in Kettering. Custom printed workwear for businesses, gyms, sports teams, events and organisations across Northamptonshire.";
  ...
  return (
    <div style={{ maxWidth: "1100px", margin: "auto", padding: "40px 20px" }}>
      ...
      Kettering and Northamptonshire. Custom polo shirts,
      ...
      <section style={{ marginBottom: "60px" }}>
        ...
        >
          Professional Workwear Printing in Kettering
        </h2>
